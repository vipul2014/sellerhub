...
public class PortFolio3 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.port_folio3);
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.btn_camera){
            ...
            Intent next= new Intent(PortFolio3.this,PortFolio4.class);
            startActivity(next);
        }
