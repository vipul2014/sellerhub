...
public class PortFolio2 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.port_folio2);
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.btn_camera){
            ...
            Intent next= new Intent(PortFolio2.this,PortFolio3.class);
            startActivity(next);
        }
