...
public class PortFolio1 extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.port_folio1);
    ...
    public void onClick(View view) {
        if(view.getId()==R.id.btn_camera){
            ...
            Intent next= new Intent(PortFolio1.this,PortFolio2.class);
            startActivity(next);
        }
